...
use Tekkl\Shared\Api\Schema\Endpoint\ApplicationRequestEndpointCollection;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateDataDeletionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateDataReadEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateDataUpsertionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateMediaDeletionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateMediaListEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateMediaUpdateEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PrivateMediaUploadEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicDataDeletionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicDataReadEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicDataUpsertionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicMediaDeletionEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicMediaListEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicMediaUpdateEndpoint;
use Tekkl\Shared\Api\Schema\Endpoint\PublicMediaUploadEndpoint;
