...
final class PublicDataWriteEndpoint extends PostEndpoint
{
    public function createOpenApiSchema(): OA\PathItem
    {
        $options = [
            'path' => $this->url,
            'post' => new OA\Post([
                'tags' => ['public-data-write'],
                'summary'     => 'Update PUBLIC element data with a given key (optional) and value',
                'description' => 'This endpoint allows you to update all or parts of your public element data, which is identified by a key.',
