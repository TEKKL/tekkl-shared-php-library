...
final class PrivateDataDeleteEndpoint extends PostEndpoint
{
    public function createOpenApiSchema(): OA\PathItem
    {
        $options = [
            'path' => $this->url,
            'post' => new OA\Post([
                'tags' => ['private-data-delete'],
                'summary'     => 'Delete PRIVATE element data with a given key (optional)',
                'description' => 'This endpoint allows you to delete all or parts of your private element data, which is identified by a key.',
